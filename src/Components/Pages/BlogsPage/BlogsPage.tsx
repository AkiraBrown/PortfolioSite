...
function BlogsPage() {
  ...
  return (
    <div className="col-span-4 font-mono min-h-screen mt-3">
      <h1 className="font-bold text-center text-xl underline underline-offset-4">
        Blogs
      </h1>
      <ul className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 overflow-auto p-5">
        {allBlogs.map(({ title, date_uploaded, id }, idx) => {
          return (
            ...
            >
              <p className="p-6 font-bold text-lg underline underline-offset-4">
                {title}
              </p>
